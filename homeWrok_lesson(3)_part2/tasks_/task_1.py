...
value_a = int(input("Enter 'a' number: "))
value_b = int(input("Enter 'b' number: "))
value_x = int(input("Enter 'x' number: "))
...
print(f"a) = {formula_a(value_a, value_b):.2f}\n"
      f"b) = {formula_b(value_x):.2f}\n"
      f"c) = {formula_c(value_x):.2f}\n"
      f"d) = {formula_d(value_x):.2f}\n")
